            ...
            <div class="inner-wrapper row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" maxlen="255" id="name" placeholder="Enter First first name" value="{{ $contact->name }}" />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="notes" id="notes" class="form-control" placeholder="Enter notes (maximum character limit : 255)">{{ $contact->notes }}</textarea>
                        </div>
